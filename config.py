...
class Config(object):
    ...
    AUTH_USERS = set(int(x) for x in os.environ.get("AUTH_USERS", "275484069").split())
    ...
    DEF_THUMB_NAIL_VID_S = os.environ.get("DEF_THUMB_NAIL_VID_S", "http://cc.gdi.workers.dev/1LySAlH8pW3A4igWz-HaannKj_hDaC8ms/2021-04-25_15:50:59.jpg")
